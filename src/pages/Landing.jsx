...
const Landing = () => {
  ...
  return (
    <div className='bg-gray-50 dark:bg-gray-900'>
         <motion.section
      className="bg-gray-50 dark:bg-gray-900 py-20 px-4 sm:px-6 lg:px-8"
      initial={{ opacity: 0, y: 50 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 1 }}
    >
      <div className="max-w-7xl mx-auto">
        {/* Mobile-first: image first, content second */}
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed max-w-2xl">
                ...
                I'm at the beginning of my journey, but I approach every project
                with excitement and a strong desire to learn and grow in the
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link to="/contact">
                <button className="px-8 py-4 bg-blue-500 text-white font-semibold rounded-lg hover:bg-[#FD0315] transform hover:scale-105 transition-all duration-200">
                  Contact Me
                </button>
              </Link>
            </div>
