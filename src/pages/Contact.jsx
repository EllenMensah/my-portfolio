...
export default function ContactForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(
        "Your email client should open now. Please send the message from there."
      );
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-gray-50 min-h-screen">
      <div  className="flex flex-col justify-center p-30">
        <h1 className="text-6xl font-extrabold flex justify-center text-[#FD0315] ">Let's Talk</h1>
        <p className="text-center pt-4">
          Have a project in mind or want to discuss a potential collaboration?
          I'd love to hear from you. Fill out the form below or reach out
          directly through the contact information.
        </p>
      </div>
